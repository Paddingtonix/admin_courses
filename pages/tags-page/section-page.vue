	...
	<div class="section-page">
		...
		<template v-if="headersStore.headings.length">
			...
			<TableRowCmp
				...
				:redirect="false"
				:name="checkForFlooding(data.name, 25)"
				:authors="checkForFlooding(data.description, 55)"
...
enum sortNames {
	status = "ascendingHeadingName",
	name = "ascendingHeadingDescription",
	lang = "ascendingLabelsCount",
}
