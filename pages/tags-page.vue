    ...
    <section class="oil-container">
        <div class="oil-page tags-page">
            ...
            <div class="tags-page__content">
                ...
                <TableRowCmp class="tags-table-row" name="sort" status="course" authors="Сортировка">
                    <template v-slot:svg>
                ...
                <div class="tags-page__pagination-wrapper">
                    ...
                    <SelectorCmp class="tags-page__selector" label="10 меток на стр." :list="list"></SelectorCmp>
                </div>
            </div>
        </div> 
    </section>
