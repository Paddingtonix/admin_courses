    ...
    <div class="oil-filter">
        ...
        <div class="oil-filter__body-wrapper">
            <div class="oil-filter__body" v-if="filter_frame.value">
                ...
                <div
                    v-for="key in Object.keys(filter_values)"
                ...
                >
                    ...
                    <CheckboxCmp
                        v-for="(checkbox, idx) in filter_values[key]"
                        :key="idx"
                        :text="checkbox.name"
                        :id="checkbox.id"
...
const { is_body_visible, filters } = defineProps({
    is_body_visible: {
        type: Boolean,
        default: false,
    },
...
const filtersArray = filterKeys.map((filterName) => {
    return filters[filterName].map((item) => ({
        ...item,
        active: false,
    }));
});

const filter_values = reactive(filtersArray);
