    ...
    <div class="oil-course-setting__edit" v-else>
        ...
        <div v-for="(field, field_idx) in edit_info.slice(2)" :key="field_idx">
            <TextareaCmp
                ...
                @set_textarea="(value) => edit_info[field_idx + 2].value = value.value"
...
const saveEditFrame = () => {
    ...
    course_info_store.patchCourseInfo(id as Number, courseInfoData)
};

watch(() => course_info_store.course_info, (newInfo) => {
    if (newInfo) {
