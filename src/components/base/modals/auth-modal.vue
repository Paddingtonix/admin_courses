                ...
                axios
                    ...
                    .then((token: { data: { token: string } }) => {
                        ...
                        if (user_valid.value && remember_me.value) {
                            localStorage.setItem('test_auth_token', token.data.token)
                        }
                    })
                    .finally(() => {
                        if(user_valid.value) {
