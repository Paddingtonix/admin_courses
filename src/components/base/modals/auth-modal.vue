<template>
    <div :class="`oil-modal__authorization`">
        <span :class="`oil-modal__authorization__title`">Вход в Admin Course</span>
        <div :class="`oil-modal__authorization__form`" v-for="form_item in form_authorization" :key="form_item.id">
            <InputCmp
                :type="form_item.type"
            ...
            />
            <svg :class="`oil-modal__authorization__icon`" v-if="form_item.type === 'password'" @click="visiblePassword(form_item.type)" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <svg :class="`oil-modal__authorization__icon`" v-if="form_item.type === 'text'" @click="visiblePassword(form_item.type)" xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none">
        ...
        <CheckboxCmp
            :class="`oil-modal__authorization__checkbox`"
            :text="'Запомнить меня'"
            :active="remember_me"
