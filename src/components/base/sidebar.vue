<template>
    <aside class="oil-sidebar" :style="{width: !opened_sidebar.value ? '72px' : '256px'}">
        ...
        <div class="oil-sidebar__expand" @click="openSidebar">
            <svg :class="{'_active-chevron': opened_sidebar.value}" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
